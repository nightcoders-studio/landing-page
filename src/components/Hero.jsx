        ...
        >
          ...
          >
            <h1 className="text-4xl font-semibold text-text-default md:text-4xl sm:leading-snug md:leading-normal lg:leading-normal lg:text-4xl xl:text-5xl xl:leading-normal 3xl:text-9xl 3xl:leading-normal">
              We&lsquo;re Here to Help You to{" "}
              <span className=" text-text-brand">Rock</span> Digital
            ...
            <h3 className="text-xl sm:text-xl text-text-default xl:text-xl xl:pr-24 md:text-xl xl:leading-normal 3xl:text-5xl 3xl:leading-normal">
              Empowering businesses to overcome digital challenges with custom
              software solutions, seamless integrations, and innovative
          ...
          <Button
            variant="default"
            className="flex items-center sm:w-full md:w-auto"
            onClick={() =>
              window.scrollTo({
          ...
          >
            Start Your Project{" "}
            <Rocket className="z-10 w-5 h-5 ml-2 text-current 3xl:w-12 3xl:h-auto" />
          </Button>
        </div>
