            ...
            >
                <div id="textHeroWrapper" className="flex flex-col items-stretch gap-4 md:gap-6">
                    ...
                    <div id="textHeroContainer" className="flex flex-col items-stretch gap-4">
                        <h1 className="text-4xl font-semibold text-text-default md:text-4xl sm:leading-snug md:leading-normal xl:text:6xl">
                            We're Here to Help You to <span className=" text-text-brand">Rock</span> Digital
                            <span className="text-text-brand"> Innovation</span>
                        </h1>
                        <h3 className="text-xl sm:text-xl text-text-default xl:text-2xl md:text-lg">
                    ...
                    <Button
                        variant="default"
                        size="lg"
                        className="mt-auto rounded-lg py-6 px-10 sm:w-full lg:w-[60%] text-xl md:text-base lg:px-20 md:mt-auto md:w-[50%] self-start">
