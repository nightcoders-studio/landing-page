  ...
  const weWork = [
    {
      ...
      subTitle:
        "We will discuss how can we provide value to you and your business.",
      button: true,
    },
    {
      id: 2,
      ...
      subTitle:
        "We'll gather the info and send a proposal. Once approved, we'll start the project.",
      button: false,
    },
    {
      id: 3,
      ...
      subTitle:
        "The team plans and communicates frequently with you to achieve the best results.",
      button: false,
    },
    {
      id: 4,
    ...
    >
      ...
      <div className="flex flex-col w-screen px-0 lg:w-screen lg:px-16 sm:px-7 md:px-7 sm:items-center sm:mx-0 sm:text-center md:flex md:flex-row md:items-center md:gap-8 md:text-left howWeWork-Container">
        ...
        <h4 className="text-text-default sm:text-lg md:text-base lg:text-xl lg:leading-relaxed lg:flex-[30%] lg:text-right 3xl:text-5xl 3xl:w-3/4 3xl:mr-12">
          A proven process to transform your ideas into powerful digital
          solutions
        </h4>
      </div>

      {/* Card Container */}
      <div className="z-10 sm:flex sm:px-6 sm:flex-col sm:gap-6 sm:w-full xl:w-full md:grid md:grid-cols-2 md:gap-6 lg:flex lg:flex-row lg:py-0 lg:px-11 lg:gap-0 xl:flex xl:flex-row ">
        {weWork.map((step) => (
          <Card
            key={step.id}
          ...
          >
            <CardHeader className="lg:gap-0 lg:p-0 sm:pb-3">
              <div className="gap-0 lg:flex xl:flex sm:hidden md:hidden sm:pb-2 ">
                <img
                  src={Ellipse}
                  className="w-5 h-5 lg:items-center xl:w-10 xl:h-auto 3xl:w-auto 3xl:h-14"
                  alt=""
                />
