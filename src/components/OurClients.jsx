...
import logoKasyapi from "@/assets/images/LogoKasyapi.svg";
import logoPoldaAceh from "@/assets/images/LogoPoldaAceh.svg";
import logoKemenkeu from "@/assets/images/LogoKemenkeu.svg";
import logoTOU from "@/assets/images/LogoTOU.svg";
import logoMugee from "@/assets/images/LogoMugee.svg";

const OurClients = () => {
  const clientsLogo = [
    { id: 1, logo: logoKasyapi },
    { id: 2, logo: logoPoldaAceh },
    { id: 3, logo: logoKemenkeu },
    { id: 4, logo: logoTOU },
    { id: 5, logo: logoMugee },
  ];
