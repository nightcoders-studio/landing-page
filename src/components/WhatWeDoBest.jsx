...
const WhatWeDoBest = () => {
  ...
  const whatWedo = [
    {
      id: 1,
      icon: (size) => (
        <Smartphone strokeWidth={1} className="h-auto" size={size} />
      ),
    ...
    },
    {
      id: 3,
      icon: (size) => (
        <BrainCircuit strokeWidth={1} className="h-auto" size={size} />
      ),
      ...
      content: [
        ...
        "Smart Chatbot",
        "Analytics for Bussiness Predictions",
      ],
    },
    {
      id: 4,
      icon: (size) => (
        <PenTool strokeWidth={1} className="h-auto" size={size} />
      ),
  ...
  return (
    <div
      ...
      className="hidden sm:flex sm:flex-col sm:items-center sm:w-full sm:mt-8 sm:gap-8 xl:w-screen lg:w-screen lg:px-4 3xl:px-16"
    >
      ...
      <div className="flex flex-col w-screen px-0 lg:w-screen lg:px-16 sm:px-7 md:px-7 sm:items-center sm:mx-0 sm:text-center md:flex md:flex-row md:items-center md:gap-8 md:text-left whatWedobest-Container">
        ...
        <h4 className="text-text-default sm:text-lg md:text-base lg:text-xl lg:leading-relaxed lg:flex-[30%] lg:text-right 3xl:text-5xl 3xl:w-3/4 3xl:mr-12">
          Delivering excellence across every stage of your digital
          transformation
        </h4>
      </div>
              ...
              >
                <Accordion.Header>
                  ...
                  >
                    ...
                    <h4
                      id="judulCard"
                      className="3xl:max-w-full lg:self-start sm:align-text-left lg:pl-8 text-text-default sm:text-xl sm:text-left md:text-xl lg:text-2xl md:font-medium sm:font-medium lg:text-left xl:text-3xl xl:max-w-64 3xl:text-6xl 3xl:leading-normal "
                    >
                      {item.title}
                    </h4>
                    ...
                    {/* Arrow Section */}
                    <div
                      className={`container-arrow flex top-0  transition-transform duration-700 ease-in-out  ${
                        activeItem === item.id
