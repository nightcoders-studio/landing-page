...
const ContentCard = ({
  ...
  return (
    <Link href={`${baseUrl}/${slug}`} className="w-full group">
      <div className="flex flex-col h-full w-full gap-6 bg-neutral-400/10 p-3 items-center rounded-2xl hover:shadow-lg transition-shadow duration-200">
        ...
        {purchase && (
          <div
            className={`flex flex-row w-full h-full ${price ? 'justify-between' : 'justify-end'} items-center w-full`}
          >
