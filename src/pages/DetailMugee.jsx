    ...
    >
      ...
      >
        ...
        >
          ...
          <Button>
            <a href="https://mugee.id">
              <b className="font-medium text-white">mugee.id</b>
            </a>
          </Button>
        </div>
      </div>
  ...
  return (
    <div className="flex flex-col w-full gap-6 xl:gap-4 about-container px-7 sm:flex sm:flex-col md:px-16">
      ...
      <h4 className="text-text-default md:w-3/4 lg:pl-1 lg:text-xl md:text-xl about-description">
        Mugee is a web application that offers a wide range of grocery and fresh
        market products delivered right to your doorstep. With just your mobile
        phone, you can conveniently order fresh products. We are committed to
        providing ease, convenience, and top-quality service in every delivery,
        ensuring you always receive fresh and high-quality items.
      </h4>
      <Spacer />
