      ...
      >
        ...
        >
          <h1 className="text-xl font-semibold text-text-default md:text-2xl sm:leading-snug md:leading-normal lg:leading-normal lg:text-3xl xl:text-4xl xl:leading-normal sm:w-3/4 3xl:text-7xl 3xl:leading-normal">
            Providing interactive and meaningful earthquake disaster mitigation
            education for children.
          </h1>
          <Button>
            <a href="https://tesujianonline.com">
              <b className="font-medium text-white">Pamaba</b>
            </a>
          </Button>
        </div>
      </div>
  ...
  return (
    <div className="flex flex-col w-full gap-6 xl:gap-4 about-container px-7 sm:flex sm:flex-col md:px-16">
      ...
      <h4 className="text-text-default md:w-3/4 lg:pl-1 lg:text-xl md:text-xl about-description">
        The PAMABA app (Palu Aman Bencana) aims to provide interactive and
        meaningful earthquake disaster mitigation education for children. The
        name &#34;Palu&#34; refers to the capital of Central Sulawesi, often
        affected by earthquakes, highlighting the app&#34;s contextual relevance
        to disaster-prone areas. &#34;Aman&#34; signifies the aim to create a
        sense of safety for children after learning about disaster mitigation,
        while &#34;Bencana&#34; emphasizes the focus on disaster preparedness.
        &#34;PAMABA&#34; is an abbreviation designed to be memorable and
        child-friendly, attracting the attention of young users.{" "}
      </h4>
      <Spacer />
