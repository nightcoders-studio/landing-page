        ...
        <div>
            ...
            <div id="heroWrapper" className="items-center sm:gap-2 sm:px-4 sm:pb-8 sm:pt-8 md:m-0">
                ...
                >
                    ...
                    <img
                        className="order-1 w-full h-auto gambarHero lg:order-2 lg:pr-5"
                    ...
                    >
                        <div id="textHeroContainer" className="flex flex-col items-stretch gap-4">
                            <h1 className="text-4xl font-semibold text-text-default md:text-4xl sm:leading-snug md:leading-normal lg:leading-normal lg:text-4xl xl:text-5xl xl:leading-normal w:full sm:w-3/4">
            ...
            <div className="flex flex-col w-full gap-8 aboutContainer px-7 sm:flex sm:flex-col md:px-16">
                ...
                <h4 className="text-text-default md:w-3/4 lg:pl-1 lg:text-2xl md:text-xl">
                    Aplikasi E-commerce berbasis web dan mobile untuk [Nama Klien], dirancang untuk
                    memberikan pengalaman belanja online yang mulus bagi pengguna dengan fokus pada
                    kecepatan, kemudahan navigasi, dan personalisasi
                </h4>
                <Spacer />
            </div>
                ...
                <div className="z-10 flex flex-col flex-grow gap-10 sm:w-full sm:px-8 sm:align-text-left">
                    <Form {...form} className="md:w-full">
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <Button
                                type="submit"
                                className="w-full text-text-default-quaternary px-4 lg:py-6 flex items-center justify-center text-base bg-transparent hover:shadow-none bg-[#293239] border-solid border-2 border-[#e4882b] rounded-lg lg:text-xl hover:translate-y-1 sm:text-lg md:text-2xl md:py-6"
                            >
                                Send Message
                            </Button>
                        </form>
