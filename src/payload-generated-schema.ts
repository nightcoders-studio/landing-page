...
export const portfolios_populated_authors = sqliteTable(
  'portfolios_populated_authors',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: text('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('portfolios_populated_authors_order_idx').on(columns._order),
    _parentIDIdx: index('portfolios_populated_authors_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [portfolios.id],
      name: 'portfolios_populated_authors_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const portfolios = sqliteTable(
  'portfolios',
  {
    ...
    aboutThisProject: text('about_this_project'),
    review_reviewImage: integer('review_review_image_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    review_reviewText: text('review_review_text'),
    review_reviewAuthor: text('review_review_author'),
    features: text('features'),
    useCases: text('use_cases'),
    techStacks_frontEnd: text('tech_stacks_front_end'),
    techStacks_backEnd: text('tech_stacks_back_end'),
    techStacks_design: text('tech_stacks_design'),
    content: text('content', { mode: 'json' }),
    meta_title: text('meta_title'),
    meta_image: integer('meta_image_id').references(() => media.id, {
      onDelete: 'set null',
  ...
  (columns) => ({
    portfolios_hero_image_idx: index('portfolios_hero_image_idx').on(columns.heroImage),
    portfolios_review_review_review_image_idx: index(
      'portfolios_review_review_review_image_idx',
    ).on(columns.review_reviewImage),
    portfolios_meta_meta_image_idx: index('portfolios_meta_meta_image_idx').on(columns.meta_image),
    portfolios_slug_idx: index('portfolios_slug_idx').on(columns.slug),
    portfolios_updated_at_idx: index('portfolios_updated_at_idx').on(columns.updatedAt),
    portfolios_created_at_idx: index('portfolios_created_at_idx').on(columns.createdAt),
    portfolios__status_idx: index('portfolios__status_idx').on(columns._status),
  }),
)

export const portfolios_rels = sqliteTable(
  'portfolios_rels',
  {
    id: integer('id').primaryKey(),
    order: integer('order'),
  ...
  (columns) => ({
    order: index('portfolios_rels_order_idx').on(columns.order),
    parentIdx: index('portfolios_rels_parent_idx').on(columns.parent),
    pathIdx: index('portfolios_rels_path_idx').on(columns.path),
    portfolios_rels_categories_id_idx: index('portfolios_rels_categories_id_idx').on(
      columns.categoriesID,
    ),
    portfolios_rels_users_id_idx: index('portfolios_rels_users_id_idx').on(columns.usersID),
    parentFk: foreignKey({
      columns: [columns['parent']],
      foreignColumns: [portfolios.id],
      name: 'portfolios_rels_parent_fk',
    }).onDelete('cascade'),
    categoriesIdFk: foreignKey({
      columns: [columns['categoriesID']],
      foreignColumns: [categories.id],
      name: 'portfolios_rels_categories_fk',
    }).onDelete('cascade'),
    usersIdFk: foreignKey({
      columns: [columns['usersID']],
      foreignColumns: [users.id],
      name: 'portfolios_rels_users_fk',
    }).onDelete('cascade'),
  }),
)

export const _portfolios_v_version_populated_authors = sqliteTable(
  '_portfolios_v_version_populated_authors',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: integer('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_portfolios_v_version_populated_authors_order_idx').on(columns._order),
    _parentIDIdx: index('_portfolios_v_version_populated_authors_parent_id_idx').on(
      columns._parentID,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_portfolios_v.id],
      name: '_portfolios_v_version_populated_authors_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _portfolios_v = sqliteTable(
  '_portfolios_v',
  {
    id: integer('id').primaryKey(),
    parent: integer('parent_id').references(() => portfolios.id, {
      onDelete: 'set null',
    }),
    version_title: text('version_title'),
    ...
    version_aboutThisProject: text('version_about_this_project'),
    version_review_reviewImage: integer('version_review_review_image_id').references(
      () => media.id,
      {
        onDelete: 'set null',
      },
    ),
    version_review_reviewText: text('version_review_review_text'),
    version_review_reviewAuthor: text('version_review_review_author'),
    version_features: text('version_features'),
    version_useCases: text('version_use_cases'),
    version_techStacks_frontEnd: text('version_tech_stacks_front_end'),
    version_techStacks_backEnd: text('version_tech_stacks_back_end'),
    version_techStacks_design: text('version_tech_stacks_design'),
    version_content: text('version_content', { mode: 'json' }),
    version_meta_title: text('version_meta_title'),
    version_meta_image: integer('version_meta_image_id').references(() => media.id, {
      onDelete: 'set null',
  ...
  (columns) => ({
    _portfolios_v_parent_idx: index('_portfolios_v_parent_idx').on(columns.parent),
    _portfolios_v_version_version_hero_image_idx: index(
      '_portfolios_v_version_version_hero_image_idx',
    ).on(columns.version_heroImage),
    _portfolios_v_version_review_version_review_review_image_idx: index(
      '_portfolios_v_version_review_version_review_review_image_idx',
    ).on(columns.version_review_reviewImage),
    _portfolios_v_version_meta_version_meta_image_idx: index(
      '_portfolios_v_version_meta_version_meta_image_idx',
    ).on(columns.version_meta_image),
    _portfolios_v_version_version_slug_idx: index('_portfolios_v_version_version_slug_idx').on(
      columns.version_slug,
    ),
    _portfolios_v_version_version_updated_at_idx: index(
      '_portfolios_v_version_version_updated_at_idx',
    ).on(columns.version_updatedAt),
    _portfolios_v_version_version_created_at_idx: index(
      '_portfolios_v_version_version_created_at_idx',
    ).on(columns.version_createdAt),
    _portfolios_v_version_version__status_idx: index(
      '_portfolios_v_version_version__status_idx',
    ).on(columns.version__status),
    _portfolios_v_created_at_idx: index('_portfolios_v_created_at_idx').on(columns.createdAt),
    _portfolios_v_updated_at_idx: index('_portfolios_v_updated_at_idx').on(columns.updatedAt),
    _portfolios_v_latest_idx: index('_portfolios_v_latest_idx').on(columns.latest),
    _portfolios_v_autosave_idx: index('_portfolios_v_autosave_idx').on(columns.autosave),
  }),
)

export const _portfolios_v_rels = sqliteTable(
  '_portfolios_v_rels',
  {
    id: integer('id').primaryKey(),
    order: integer('order'),
  ...
  (columns) => ({
    order: index('_portfolios_v_rels_order_idx').on(columns.order),
    parentIdx: index('_portfolios_v_rels_parent_idx').on(columns.parent),
    pathIdx: index('_portfolios_v_rels_path_idx').on(columns.path),
    _portfolios_v_rels_categories_id_idx: index('_portfolios_v_rels_categories_id_idx').on(
      columns.categoriesID,
    ),
    _portfolios_v_rels_users_id_idx: index('_portfolios_v_rels_users_id_idx').on(columns.usersID),
    parentFk: foreignKey({
      columns: [columns['parent']],
      foreignColumns: [_portfolios_v.id],
      name: '_portfolios_v_rels_parent_fk',
    }).onDelete('cascade'),
    categoriesIdFk: foreignKey({
      columns: [columns['categoriesID']],
      foreignColumns: [categories.id],
      name: '_portfolios_v_rels_categories_fk',
    }).onDelete('cascade'),
    usersIdFk: foreignKey({
      columns: [columns['usersID']],
      foreignColumns: [users.id],
      name: '_portfolios_v_rels_users_fk',
    }).onDelete('cascade'),
  }),
)

export const stores_populated_authors = sqliteTable(
  'stores_populated_authors',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: text('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('stores_populated_authors_order_idx').on(columns._order),
    _parentIDIdx: index('stores_populated_authors_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [stores.id],
      name: 'stores_populated_authors_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const stores = sqliteTable(
  'stores',
  {
    id: integer('id').primaryKey(),
    title: text('title'),
    priceWithCurrency: text('price_with_currency'),
    period: text('period'),
    heroImage: integer('hero_image_id').references(() => media.id, {
      onDelete: 'set null',
    }),
  ...
  (columns) => ({
    stores_hero_image_idx: index('stores_hero_image_idx').on(columns.heroImage),
    stores_review_review_review_image_idx: index('stores_review_review_review_image_idx').on(
      columns.review_reviewImage,
    ),
    stores_meta_meta_image_idx: index('stores_meta_meta_image_idx').on(columns.meta_image),
    stores_slug_idx: index('stores_slug_idx').on(columns.slug),
    stores_updated_at_idx: index('stores_updated_at_idx').on(columns.updatedAt),
    stores_created_at_idx: index('stores_created_at_idx').on(columns.createdAt),
    stores__status_idx: index('stores__status_idx').on(columns._status),
  }),
)

export const stores_rels = sqliteTable(
  'stores_rels',
  {
    id: integer('id').primaryKey(),
    order: integer('order'),
  ...
  (columns) => ({
    order: index('stores_rels_order_idx').on(columns.order),
    parentIdx: index('stores_rels_parent_idx').on(columns.parent),
    pathIdx: index('stores_rels_path_idx').on(columns.path),
    stores_rels_categories_id_idx: index('stores_rels_categories_id_idx').on(columns.categoriesID),
    stores_rels_users_id_idx: index('stores_rels_users_id_idx').on(columns.usersID),
    parentFk: foreignKey({
      columns: [columns['parent']],
      foreignColumns: [stores.id],
      name: 'stores_rels_parent_fk',
    }).onDelete('cascade'),
    categoriesIdFk: foreignKey({
      columns: [columns['categoriesID']],
      foreignColumns: [categories.id],
      name: 'stores_rels_categories_fk',
    }).onDelete('cascade'),
    usersIdFk: foreignKey({
      columns: [columns['usersID']],
      foreignColumns: [users.id],
      name: 'stores_rels_users_fk',
    }).onDelete('cascade'),
  }),
)

export const _stores_v_version_populated_authors = sqliteTable(
  '_stores_v_version_populated_authors',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: integer('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_stores_v_version_populated_authors_order_idx').on(columns._order),
    _parentIDIdx: index('_stores_v_version_populated_authors_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_stores_v.id],
      name: '_stores_v_version_populated_authors_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _stores_v = sqliteTable(
  '_stores_v',
  {
    id: integer('id').primaryKey(),
    parent: integer('parent_id').references(() => stores.id, {
      onDelete: 'set null',
    }),
    version_title: text('version_title'),
    version_priceWithCurrency: text('version_price_with_currency'),
    version_period: text('version_period'),
    version_heroImage: integer('version_hero_image_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    version_aboutThisProject: text('version_about_this_project'),
  ...
  (columns) => ({
    _stores_v_parent_idx: index('_stores_v_parent_idx').on(columns.parent),
    _stores_v_version_version_hero_image_idx: index('_stores_v_version_version_hero_image_idx').on(
      columns.version_heroImage,
    ),
    _stores_v_version_review_version_review_review_image_idx: index(
      '_stores_v_version_review_version_review_review_image_idx',
    ).on(columns.version_review_reviewImage),
    _stores_v_version_meta_version_meta_image_idx: index(
      '_stores_v_version_meta_version_meta_image_idx',
    ).on(columns.version_meta_image),
    _stores_v_version_version_slug_idx: index('_stores_v_version_version_slug_idx').on(
      columns.version_slug,
    ),
    _stores_v_version_version_updated_at_idx: index('_stores_v_version_version_updated_at_idx').on(
      columns.version_updatedAt,
    ),
    _stores_v_version_version_created_at_idx: index('_stores_v_version_version_created_at_idx').on(
      columns.version_createdAt,
    ),
    _stores_v_version_version__status_idx: index('_stores_v_version_version__status_idx').on(
      columns.version__status,
    ),
    _stores_v_created_at_idx: index('_stores_v_created_at_idx').on(columns.createdAt),
    _stores_v_updated_at_idx: index('_stores_v_updated_at_idx').on(columns.updatedAt),
    _stores_v_latest_idx: index('_stores_v_latest_idx').on(columns.latest),
    _stores_v_autosave_idx: index('_stores_v_autosave_idx').on(columns.autosave),
  }),
)

export const _stores_v_rels = sqliteTable(
  '_stores_v_rels',
  {
    id: integer('id').primaryKey(),
    order: integer('order'),
  ...
  (columns) => ({
    order: index('_stores_v_rels_order_idx').on(columns.order),
    parentIdx: index('_stores_v_rels_parent_idx').on(columns.parent),
    pathIdx: index('_stores_v_rels_path_idx').on(columns.path),
    _stores_v_rels_categories_id_idx: index('_stores_v_rels_categories_id_idx').on(
      columns.categoriesID,
    ),
    _stores_v_rels_users_id_idx: index('_stores_v_rels_users_id_idx').on(columns.usersID),
    parentFk: foreignKey({
      columns: [columns['parent']],
      foreignColumns: [_stores_v.id],
      name: '_stores_v_rels_parent_fk',
    }).onDelete('cascade'),
    categoriesIdFk: foreignKey({
      columns: [columns['categoriesID']],
      foreignColumns: [categories.id],
      name: '_stores_v_rels_categories_fk',
    }).onDelete('cascade'),
    usersIdFk: foreignKey({
      columns: [columns['usersID']],
      foreignColumns: [users.id],
      name: '_stores_v_rels_users_fk',
    }).onDelete('cascade'),
  }),
)
...
export const payload_locked_documents_rels = sqliteTable(
  ...
  (columns) => ({
    ...
    payload_locked_documents_rels_portfolios_id_idx: index(
      'payload_locked_documents_rels_portfolios_id_idx',
    ).on(columns.portfoliosID),
    payload_locked_documents_rels_stores_id_idx: index(
      'payload_locked_documents_rels_stores_id_idx',
    ).on(columns.storesID),
    ...
    portfoliosIdFk: foreignKey({
      columns: [columns['portfoliosID']],
      foreignColumns: [portfolios.id],
      name: 'payload_locked_documents_rels_portfolios_fk',
    }).onDelete('cascade'),
    storesIdFk: foreignKey({
      columns: [columns['storesID']],
      foreignColumns: [stores.id],
      name: 'payload_locked_documents_rels_stores_fk',
    }).onDelete('cascade'),
...
export const relations_portfolios_populated_authors = relations(
  portfolios_populated_authors,
  ({ one }) => ({
    _parentID: one(portfolios, {
      fields: [portfolios_populated_authors._parentID],
      references: [portfolios.id],
      relationName: 'populatedAuthors',
    }),
  }),
)
export const relations_portfolios_rels = relations(portfolios_rels, ({ one }) => ({
  parent: one(portfolios, {
    fields: [portfolios_rels.parent],
    references: [portfolios.id],
    relationName: '_rels',
  }),
  categoriesID: one(categories, {
    fields: [portfolios_rels.categoriesID],
    references: [categories.id],
    relationName: 'categories',
  }),
  usersID: one(users, {
    fields: [portfolios_rels.usersID],
    references: [users.id],
    relationName: 'users',
  }),
}))
export const relations_portfolios = relations(portfolios, ({ one, many }) => ({
  heroImage: one(media, {
    fields: [portfolios.heroImage],
    references: [media.id],
    relationName: 'heroImage',
  }),
  review_reviewImage: one(media, {
    fields: [portfolios.review_reviewImage],
    references: [media.id],
    relationName: 'review_reviewImage',
  }),
  meta_image: one(media, {
    fields: [portfolios.meta_image],
    references: [media.id],
    relationName: 'meta_image',
  }),
  populatedAuthors: many(portfolios_populated_authors, {
    relationName: 'populatedAuthors',
  }),
  _rels: many(portfolios_rels, {
    relationName: '_rels',
  }),
}))
export const relations__portfolios_v_version_populated_authors = relations(
  _portfolios_v_version_populated_authors,
  ({ one }) => ({
    _parentID: one(_portfolios_v, {
      fields: [_portfolios_v_version_populated_authors._parentID],
      references: [_portfolios_v.id],
      relationName: 'version_populatedAuthors',
    }),
  }),
)
export const relations__portfolios_v_rels = relations(_portfolios_v_rels, ({ one }) => ({
  parent: one(_portfolios_v, {
    fields: [_portfolios_v_rels.parent],
    references: [_portfolios_v.id],
    relationName: '_rels',
  }),
  categoriesID: one(categories, {
    fields: [_portfolios_v_rels.categoriesID],
    references: [categories.id],
    relationName: 'categories',
  }),
  usersID: one(users, {
    fields: [_portfolios_v_rels.usersID],
    references: [users.id],
    relationName: 'users',
  }),
}))
export const relations__portfolios_v = relations(_portfolios_v, ({ one, many }) => ({
  parent: one(portfolios, {
    fields: [_portfolios_v.parent],
    references: [portfolios.id],
    relationName: 'parent',
  }),
  version_heroImage: one(media, {
    fields: [_portfolios_v.version_heroImage],
    references: [media.id],
    relationName: 'version_heroImage',
  }),
  version_review_reviewImage: one(media, {
    fields: [_portfolios_v.version_review_reviewImage],
    references: [media.id],
    relationName: 'version_review_reviewImage',
  }),
  version_meta_image: one(media, {
    fields: [_portfolios_v.version_meta_image],
    references: [media.id],
    relationName: 'version_meta_image',
  }),
  version_populatedAuthors: many(_portfolios_v_version_populated_authors, {
    relationName: 'version_populatedAuthors',
  }),
  _rels: many(_portfolios_v_rels, {
    relationName: '_rels',
  }),
}))
export const relations_stores_populated_authors = relations(
  stores_populated_authors,
  ({ one }) => ({
    _parentID: one(stores, {
      fields: [stores_populated_authors._parentID],
      references: [stores.id],
      relationName: 'populatedAuthors',
    }),
  }),
)
export const relations_stores_rels = relations(stores_rels, ({ one }) => ({
  parent: one(stores, {
    fields: [stores_rels.parent],
    references: [stores.id],
    relationName: '_rels',
  }),
  categoriesID: one(categories, {
    fields: [stores_rels.categoriesID],
    references: [categories.id],
    relationName: 'categories',
  }),
  usersID: one(users, {
    fields: [stores_rels.usersID],
    references: [users.id],
    relationName: 'users',
  }),
}))
export const relations_stores = relations(stores, ({ one, many }) => ({
  heroImage: one(media, {
    fields: [stores.heroImage],
    references: [media.id],
    relationName: 'heroImage',
  }),
  review_reviewImage: one(media, {
    fields: [stores.review_reviewImage],
    references: [media.id],
    relationName: 'review_reviewImage',
  }),
  meta_image: one(media, {
    fields: [stores.meta_image],
    references: [media.id],
    relationName: 'meta_image',
  }),
  populatedAuthors: many(stores_populated_authors, {
    relationName: 'populatedAuthors',
  }),
  _rels: many(stores_rels, {
    relationName: '_rels',
  }),
}))
export const relations__stores_v_version_populated_authors = relations(
  _stores_v_version_populated_authors,
  ({ one }) => ({
    _parentID: one(_stores_v, {
      fields: [_stores_v_version_populated_authors._parentID],
      references: [_stores_v.id],
      relationName: 'version_populatedAuthors',
    }),
  }),
)
export const relations__stores_v_rels = relations(_stores_v_rels, ({ one }) => ({
  parent: one(_stores_v, {
    fields: [_stores_v_rels.parent],
    references: [_stores_v.id],
    relationName: '_rels',
  }),
  categoriesID: one(categories, {
    fields: [_stores_v_rels.categoriesID],
    references: [categories.id],
    relationName: 'categories',
  }),
  usersID: one(users, {
    fields: [_stores_v_rels.usersID],
    references: [users.id],
    relationName: 'users',
  }),
}))
export const relations__stores_v = relations(_stores_v, ({ one, many }) => ({
  parent: one(stores, {
    fields: [_stores_v.parent],
    references: [stores.id],
    relationName: 'parent',
  }),
  version_heroImage: one(media, {
    fields: [_stores_v.version_heroImage],
    references: [media.id],
    relationName: 'version_heroImage',
  }),
  version_review_reviewImage: one(media, {
    fields: [_stores_v.version_review_reviewImage],
    references: [media.id],
    relationName: 'version_review_reviewImage',
  }),
  version_meta_image: one(media, {
    fields: [_stores_v.version_meta_image],
    references: [media.id],
    relationName: 'version_meta_image',
  }),
  version_populatedAuthors: many(_stores_v_version_populated_authors, {
    relationName: 'version_populatedAuthors',
  }),
  _rels: many(_stores_v_rels, {
    relationName: '_rels',
  }),
}))
...
export const relations_payload_locked_documents_rels = relations(
  ...
  ({ one }) => ({
    ...
    storesID: one(stores, {
      fields: [payload_locked_documents_rels.storesID],
      references: [stores.id],
      relationName: 'stores',
    }),
...
type DatabaseSchema = {
  ...
  users: typeof users
  portfolios_populated_authors: typeof portfolios_populated_authors
  portfolios: typeof portfolios
  portfolios_rels: typeof portfolios_rels
  _portfolios_v_version_populated_authors: typeof _portfolios_v_version_populated_authors
  _portfolios_v: typeof _portfolios_v
  _portfolios_v_rels: typeof _portfolios_v_rels
  stores_populated_authors: typeof stores_populated_authors
  stores: typeof stores
  stores_rels: typeof stores_rels
  _stores_v_version_populated_authors: typeof _stores_v_version_populated_authors
  _stores_v: typeof _stores_v
  _stores_v_rels: typeof _stores_v_rels
  ...
  relations_portfolios_populated_authors: typeof relations_portfolios_populated_authors
  relations_portfolios_rels: typeof relations_portfolios_rels
  relations_portfolios: typeof relations_portfolios
  relations__portfolios_v_version_populated_authors: typeof relations__portfolios_v_version_populated_authors
  relations__portfolios_v_rels: typeof relations__portfolios_v_rels
  relations__portfolios_v: typeof relations__portfolios_v
  relations_stores_populated_authors: typeof relations_stores_populated_authors
  relations_stores_rels: typeof relations_stores_rels
  relations_stores: typeof relations_stores
  relations__stores_v_version_populated_authors: typeof relations__stores_v_version_populated_authors
  relations__stores_v_rels: typeof relations__stores_v_rels
  relations__stores_v: typeof relations__stores_v
